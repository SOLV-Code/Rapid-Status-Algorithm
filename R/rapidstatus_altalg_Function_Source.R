...
# NOTE: This version has all the candidate algorithms


rapid_status_altalg <- function(data.df, algorithm = "Minimalist", id.col = "CU_ID", status.labels = c("Red","RedAmber","Amber","AmberGreen","Green", "None","NotRed"),
...
if("IntStatus" %in% names(data.df)){  # do confusion matrix
   out.obj <- c(out.obj, list(confusion = confusion.tab,accuracy = accuracy.list))
